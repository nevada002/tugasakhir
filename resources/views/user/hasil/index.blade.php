        ...
        <tbody>
            @forelse ($hasils as $data)
                <tr>
                    ...
                    <td>
                        <a class="text-bold" href="#" onclick="showModal(this)"
                            @if ($data->nota_type === 'App\Models\NotaKapal') data-type="nota-kapal"
              ...
              @else
                ...
                data-alasan="{{ $data->nota->alasan }}" @endif
                            ...
                            data-note-pt="{{ @$data->berita_acara->penanda_tangan_keterangan ?? '-' }}"
                            ...
                            data-note-pv="{{ @$data->berita_acara->pihak_verifikasi_keterangan ?? '-' }}">
                            {{ $data->no_keluhan }}
                        </a>
                    </td>
                    ...
                    <td>
                        @if ($data->status == \App\Enum\Status::APPROVED->value)
                            <a href="{{ route('hasil.pdf', $data->id) }}" class="btn btn-secondary" target="_blank">
                                Download Pdf
                            </a>
                        @else
                            -
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label class="col-12 col-sm-4 col-form-label">Keterangan</label>
                        <div class="col-12 col-sm-8">
                            <textarea id="notePv" rows="3" class="form-control" disabled></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <label class="col-12 col-sm-4 col-form-label">Keterangan</label>
                        <div class="col-12 col-sm-8">
                            <textarea id="notePt" rows="3" class="form-control" disabled></textarea>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    <script>
        ...
        function showModal(e) {
            ...
            $('#notePt').val(data.notePt);
            $('#notePv').val(data.notePv);
