    ...
    <div class="card-body">
        ...
        <div class="row mt-4 ">
            ...
            <div class="col form-check form-check-inline">
                <button type="button" class="btn btn-primary" style="background: none; border: none;"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/login">
                                ...
                                <div class="col mb-3">
                                    <input type="password" class="form-control border-0" id="exampleFormControlInput1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                style="background: none; border: none;">
                                <div class="col mt-4 text-dark ">Sudah memiliki akun?<a href="loginadmin.php">Login</a>
                                </div>Login
                            </button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                style="background: none; border: none;">
                                <div class="col mt-4 text-dark ">Sudah memiliki akun?<a href="/login">Login</a></div>
                                Login
                            </button>
                            <a href="loginadmin.php"><button type="submit" class="btn btn-primary">Daftar</button></a>
                        </div>
