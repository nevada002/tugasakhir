...
@section('content')
    ...
    <div class="form-group mb-3 row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" value="{{ $beritaAcara->tanggal->format('Y-m-d') }}" name="tanggal" placeholder="Tanggal" disabled>
        </div>
    </div>
    <div class="form-group mb-3 row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" value="{{ $beritaAcara->nama_kapal }}" name="nama_kapal" placeholder="Nama Kapal" disabled>
        </div>
    </div>
    <div class="form-group mb-3 row">
        <label class="col-sm-2 col-form-label" for="noppkb">No.PPKB / Ke</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" value="{{ $beritaAcara->noppkb }}" name="noppkb" placeholder="No.PPKB / Ke" disabled>
        </div>
        <label class="col-sm-2 col-form-label" for="service_code">Service Code</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" value="{{ $beritaAcara->service_code }}" name="service_code" placeholder="Service Code" disabled>
        </div>
    </div>
    <div class="form-group mb-3 row">
        <label class="col-sm-2 col-form-label" for="noukk">No. UKK</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" value="{{ $beritaAcara->noukk }}" name="noukk" placeholder="No. UKK" disabled>
        </div>
        <label class="col-sm-2 col-form-label" for="agen">Agen</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" value="{{ $beritaAcara->agen }}" name="agen" placeholder="Agen" disabled>
        </div>
    </div>
    <div class="form-group mb-3 row">
        <label class="col-sm-2 col-form-label" for="lokasi">Lokasi</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" value="{{ $beritaAcara->lokasi }}" name="lokasi" placeholder="Lokasi" disabled>
        </div>
        <label class="col-sm-2 col-form-label" for="tujuan">Tujuan</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" value="{{ $beritaAcara->tujuan }}" name="tujuan" placeholder="Tujuan" disabled>
        </div>
    </div>
    <div class="form-group mb-3 row">
