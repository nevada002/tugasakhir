...
@section('content')
    ...
    <form action="{{ route('admin.penghapusan-ppkb.berita-acara.update', $beritaAcara->id) }}" method="POST"
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" value="{{ $beritaAcara->nama_perusahaan }}"
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" value="{{ $beritaAcara->noppkb }}" name="noppkb"
                    placeholder="No.PPKB / Ke" required>
            </div>
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" value="{{ $beritaAcara->noukk }}" name="noukk"
                    placeholder="No. UKK" required>
            </div>
            <label class="col-sm-2 col-form-label" for="agen">Agen</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" value="{{ $beritaAcara->agen }}" name="agen"
                    placeholder="Agen" required>
            </div>
        </div>
        <div class="form-group mb-3 row">
