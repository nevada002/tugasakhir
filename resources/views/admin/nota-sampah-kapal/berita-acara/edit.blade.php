...
@section('content')
    ...
    <form action="{{ route('admin.nota-sampah-kapal.berita-acara.update', $beritaAcara->id) }}" method="POST"
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="date" class="form-control" value="{{ $beritaAcara->tanggal }}" name="tanggal"
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="date" class="form-control" value="{{ $beritaAcara->tanggalnotasampahkapal }}"
                    name="tanggalnotasampahkapal" placeholder="tanggalnotasampahkapal" required>
            </div>
