...
@section('content')
    ...
    <form action="{{ route('admin.nota-sampah-kapal.berita-acara.update', $beritaAcara->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="date" class="form-control" value="{{ $beritaAcara->tanggal }}" name="tanggal" placeholder="Tanggal" required>
            </div>
        </div>
        <div class="form-group mb-3 row">
            <label class="col-sm-2 col-form-label">Tanggal Nota</label>
            <div class="col-sm-4">
                <input type="date" class="form-control" value="{{ $beritaAcara->tanggalnotasampahkapal }}" name="tanggalnotasampahkapal"
