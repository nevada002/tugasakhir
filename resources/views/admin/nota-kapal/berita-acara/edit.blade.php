...
@section('content')
    ...
    <form action="{{ route('admin.nota-kapal.berita-acara.update', $beritaAcara->id) }}" method="POST"
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal"
                    value="{{ $beritaAcara->tanggal->format('Y-m-d') }}" required>
            </div>
        </div>
        <div class="form-group mb-3 row">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="perihal" name="perihal" placeholder="Perihal"
                    value="{{ $beritaAcara->perihal }}" required>
            </div>
        </div>
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="dibuatoleh" name="dibuatoleh" placeholder="Di Buat Oleh"
                    value="{{ $beritaAcara->dibuatoleh }}" required>
            </div>
        </div>
        <div class="form-group mb-3 row">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-sm-4">
                <textarea type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan"
                    rows="2" required>{{ $beritaAcara->keterangan }}</textarea>
            </div>
        </div>
