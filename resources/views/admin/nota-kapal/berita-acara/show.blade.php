...
@section('content')
    ...
    <div class="form-group mb-3 row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal"
                value="{{ $beritaAcara->tanggal->format('Y-m-d') }}" @disabled(true)>
        </div>
    </div>
    <div class="form-group mb-3 row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="no_surat_perusahaan" name="no_surat_perusahaan"
                placeholder="No Surat Perusahaan" value="{{ $beritaAcara->no_surat_perusahaan }}"
                @disabled(true)>
        </div>
    </div>
    <div class="form-group mb-3 row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" id="tanggal_surat" name="tanggal_surat" placeholder="Tanggal Surat"
                value="{{ $beritaAcara->tanggal_surat->format('Y-m-d') }}" @disabled(true)>
        </div>
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="perihal" name="perihal" placeholder="Perihal"
                value="{{ $beritaAcara->perihal }}" @disabled(true)>
        </div>
    </div>
    <div class="form-group mb-3 row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" id="dibuatoleh" name="dibuatoleh" placeholder="Di Buat Oleh"
                value="{{ $beritaAcara->dibuatoleh }}" @disabled(true)>
        </div>
    </div>
    <div class="form-group mb-3 row">
    ...
    <div class="form-group mb-3 row">
        ...
        <div class="col-sm-10">
            <textarea type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan" rows="2"
                @disabled(true)>{{ $beritaAcara->keterangan }}</textarea>
        </div>
    </div>
@endsection
