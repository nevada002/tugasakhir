                ...
                <div class="card-body px-5 pb-5">
                    ...
                    <div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role" value="agen"
                                        id="agen" @if (old('role') == 1) checked @endif>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role" value="cs"
                                        id="cs" @if (old('role') == 2) checked @endif>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role" value="pt"
                                        id="pt" @if (old('role') == 3) checked @endif>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="role" value="pv"
                                        id="pv" @if (old('role') == 4) checked @endif>
                    ...
                    {{-- Form Agen --}}
                    <form method="POST" action="{{ route('register') }}" id="form-agen" class="form"
                        style="display: none;">
                        @csrf
                        <hr>
                        <input type="hidden" name="role" value="1">
                        <div class="col mt-auto mb-3 ">
                            <input name="name" type="text" class="form-control" placeholder="Nama Agen"
                    ...
                    <form method="POST" action="{{ route('register') }}" id="form-cs" class="form"
                        style="display: none;">
                        @csrf
                        <hr>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="d-flex justify-content-between">
                                    <div class="my-auto">Sudah memiliki akun? <a href="{{ route('login') }}">Masuk</a>
                                    </div>
                                    <button type="submit" class="btn btn-primary">Daftar</button>
                                </div>
                            </div>
                    ...
                    {{-- Form Penanda Tangan --}}
                    <form method="POST" action="{{ route('register') }}" id="form-pt" class="form"
                        style="display: none;">
                        @csrf
                        <hr>
                    ...
                    <form method="POST" action="{{ route('register') }}" id="form-pv" class="form"
                        style="display: none;">
                        @csrf
                        <hr>
