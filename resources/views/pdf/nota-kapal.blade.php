...
<head>
    ...
    <title>BERITA ACARA KOREKSI NOTA KAPAL</title>
</head>
<body>
    <h3 style="text-align: center; margin-bottom: 0;">BERITA ACARA KOREKSI NOTA KAPAL</h3>
    ...
    <ol style="padding-left: 17;">
        <li>Berdasarkan surat {{ $hasil->berita_acara->nama_perusahaan }}, No: {{ $hasil->berita_acara->no_surat_perusahaan }}, tanggal {{ $hasil->berita_acara->tanggal_surat->locale('id')->isoFormat('dddd MMMM YYYY') }}, perihal: Permohonan Pengajuan Koreksi Nota 0893489348989 CALIDRIS. MV periode Kunjungan 25/07/2021 s.d 26/07/2021</li>
        <li>
            Setelah diadakan penelitian dan evaluasi atas permohonan koreksi tersebut dapat dijelaskan sebagai berikut:
        ...
        <li>Demikian Berita Acara ini dibuat dengan sebenarnya untuk dipergunakan sebagaimana mestinya dan apabila dikemudian hari terdapat kekeliruan dapat diperbaiki sebagaimana harusnya.</li>
    </ol>
    <br>
    <br>
